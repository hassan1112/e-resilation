                        ...
                        {data
                            .filter((item) => {
                                ...
                                return (
                                    ...
                                    (item.NNI && item.NNI.titre && item.NNI.titre.toLowerCase().includes(searchTerm)) ||
                                    (item.NNI && item.NNI.representant && item.NNI.representant.toLowerCase().includes(searchTerm)) ||
                            ...
                            .map((item) => (
                                ...
                                >
                                    ...
                                    <TableCell>{item.NNI.titre}</TableCell>
                                    <TableCell>{item.NNI.representant}</TableCell>
...
export default function DechargeFormulaire() {
    ...
    const [data] = useState([
        {
            requestId: '001',
            NNI: { titre: '123456', représentant: '654321' },
            numeroTitre: '789',
