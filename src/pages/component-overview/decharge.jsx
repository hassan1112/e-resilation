            ...
            {data
              .filter((item) => {
                ...
                return (
                  ...
                  (item.nni_titre &&
                    item.nni_titre.toLowerCase().includes(searchTerm)) ||
                  (item.nni_representant &&
                    item.nni_representant.toLowerCase().includes(searchTerm)) ||
                  (item.nomRepresentant &&
                    item.nomRepresentant.toLowerCase().includes(searchTerm)) ||
                  (item.typeDocument &&
                    item.typeDocument.toLowerCase().includes(searchTerm))
                );
              })
              .map((item) => (
                <TableRow
